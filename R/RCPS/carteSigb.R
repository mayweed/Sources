...
#xls : search for ods
bibT <- read_excel(path="C:/Users/Raimondeaug/Documents/DONNEES_R/BIB_SIGB.xlsx",
                   sheet=1,
                   col_names=TRUE)
...
png("C:/Users/Raimondeaug/Documents/CARTES_R/carteSigb91.png",width=800,height=800,res=100)
