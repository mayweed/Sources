...
#xls : search for ods
bibT <- read_excel(path="C:/Users/Raimondeaug/Documents/DONNEES_R/BIB_DOCS.xlsx",
                   sheet=1,
                   col_names=TRUE)
...
#toujours avant init()
png("C:/Users/Raimondeaug/Documents/CARTES_R/carteOffreDoc.png",width=800,height=800,res=100)
