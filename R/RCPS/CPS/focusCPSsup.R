...
# pas parlant, à faire avec les ratios…
...
png("C:/Users/Raimondeaug/Documents/CARTES_R/focusCPS_Superficie.png",width=800,height=800,res=100)
...
mf_title(txt = "Superficie des bib. par commune - CPS")
