...
create table if not exists coordonnees2020 (
...
create table if not exists prets2020 (
...
create table if not exists personnel2020 (
...
create table if not exists budget2020 (
    bibId smallint primary key,
    bibCode int,
    F101 mediumint,
    F102 mediumint,
...
create table if not exists usagers2020(
    bibId smallint primary key,
    bibcode int,
    E101 smallint,
    E102 smallint,
...
create table if not exists acces2020(
    bibId smallint primary key,
    bibCode int,
    C101 smallint,
    C102 smallint,
...
create table if not exists docs2020 (
    bibId smallint primary key,
    D101 mediumint,
    D102 mediumint,
    D103 mediumint,
